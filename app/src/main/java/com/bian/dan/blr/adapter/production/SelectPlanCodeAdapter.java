...
public class SelectPlanCodeAdapter extends BaseAdapter {

    private Activity activity;
    private List<ProductPlan.ListBean> list;
    public SelectPlanCodeAdapter(Activity activity, List<ProductPlan.ListBean> list) {
        super();
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        holder.tvName.setText(listBean.getPlanCode());
        return view;
    }
