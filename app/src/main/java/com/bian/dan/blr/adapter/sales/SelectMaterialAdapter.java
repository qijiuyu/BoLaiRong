...
public class SelectMaterialAdapter extends BaseAdapter {
    ...
    private List<Material.ListBean> list;
    public SelectMaterialAdapter(Activity activity, List<Material.ListBean> list) {
        super();
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        Material.ListBean listBean=list.get(position);
        holder.tvName.setText(listBean.getName()+"/"+listBean.getBrand()+"/"+listBean.getSpec());
