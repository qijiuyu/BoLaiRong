...
public class SelectSupplierAdapter extends BaseAdapter {
    ...
    private List<SupplierName.ListBean> list;
    public SelectSupplierAdapter(Activity activity, List<SupplierName.ListBean> list) {
        super();
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        SupplierName.ListBean listBean=list.get(position);
        holder.tvName.setText(listBean.getSupplierName());
        return view;
    }
