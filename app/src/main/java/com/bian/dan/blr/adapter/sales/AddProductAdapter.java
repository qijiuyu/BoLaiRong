...
public class AddProductAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        holder.tvPrice.setText(Html.fromHtml("单价：<font color=\"#000000\">"+goods.getProp1()+"</font>"));
        holder.tvMoney.setText(Html.fromHtml("金额：<font color=\"#FF4B4C\">"+goods.getProp2()+"</font>"));
        holder.tvRemark.setText("备注："+goods.getMemo());
        if(goods.getProp3().equals("1")){
