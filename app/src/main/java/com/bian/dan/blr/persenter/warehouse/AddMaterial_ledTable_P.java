...
import com.bian.dan.blr.activity.main.warehouse.AddMaterial_LedTable_Activity;
...
public class AddMaterial_ledTable_P {

    private AddMaterial_LedTable_Activity activity;

    public AddMaterial_ledTable_P(AddMaterial_LedTable_Activity activity){
            ...
            view.findViewById(R.id.tv_confirm).setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    if(type==1){
                        ...
                        activity.editEditText((int)textView.getTag());
                    }else{
                        if(position==0){
                            textView.setTag(5);
                        }else{
