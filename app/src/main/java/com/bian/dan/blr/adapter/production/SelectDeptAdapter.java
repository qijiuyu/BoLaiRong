...
public class SelectDeptAdapter extends BaseAdapter {
    ...
    private List<Dept.DeptBean> list;
    public SelectDeptAdapter(Activity activity, List<Dept.DeptBean> list) {
        super();
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        Dept.DeptBean deptBean=list.get(position);
        holder.tvName.setText(deptBean.getName());
        holder.tvName.setTag(deptBean);
        return view;
    }
